...
public interface UserDao {
    ...
    void removeUserAndToken(@Param("userId") long userId);

    boolean isEnabled(@Param("userId") long userId);

    void setEnabled(@Param("userId") long userId);

    void changePassword(@Param("userId") long userId, @Param("password") String hashedPassword);
}
