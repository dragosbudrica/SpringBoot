...
public class EnrollmentService {
    ...
    public boolean alreadyEnrolled(Student student, Course course) {
        List<Course> studentCourses = enrollmentDao.getCoursesOfStudent(student.getStudentId());
        return studentCourses.stream().anyMatch(currentCourse -> currentCourse.getCourseCode() == course.getCourseCode());
    }
