...
public class CourseService {
    ...
    private static final String BEGINNING_OF_SCHOOL = "2017-10-01";
    private static final String END_OF_SCHOOL = "2018-07-01";
    ...
    public void addCourse(String courseName, String category, int numberOfLectures, String description, String email) throws CourseAlreadyExistsException {
        ...
        if(allCourses.stream().anyMatch(currentCourse -> currentCourse.getCourseName().equals(courseName))) {
    ...
    public List<CourseDto> getAllRecurrentEvents() {
        List<CourseDto> events = new ArrayList<CourseDto>();
        try {
            for (CourseDto currentCourseDto : getOnlyCoursesWithDates()) {
                List<CourseDto> reccurentCourses = getAllRecurrentCourses(currentCourseDto);
    ...
    public List<CourseDto> getAllRecurrentCourses(CourseDto course) {
        ...
        try {
            ...
            while (c.getTime().compareTo(beg) > 0) {
                ...
                recurringEvent.setCourseCode(course.getCourseCode());
    ...
    public List<String> getAllCourseTitles() {
        ...
        myCourses.forEach(currentCourse->courses.add(currentCourse.getCourseName()));
        return courses;
    }
